  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-muted-foreground">
        This is what the MCP Hub exposes to AI clients (tools list). Built-in tools are merged with this dynamic registry.
      </p>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Dynamic skills from registry, exposed as tool calls with the "skill:" prefix.
          </p>
        </CardHeader>
        <CardContent>
          {isLoading ? (
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="text-muted-foreground">No dynamic prompts.</p>
          ) : (
            <ul className="space-y-2 font-mono text-sm">
              {prompts.filter((p: { enabled?: boolean }) => p.enabled !== false).map((p: { name: string; description?: string; content?: string }) => (
